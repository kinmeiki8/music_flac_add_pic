...
- **高画質アートワークの取得**: iTunes APIから取得できる最大サイズ（1400x1400〜3000x3000ピクセルなど）の画像を自動変形・ダウンロードします。
- **自動埋め込み**: Pythonの `mutagen` ライブラリを使用し、FLACファイルの `PICTURE` メタデータにジャケット画像を安全に埋め込みます。
